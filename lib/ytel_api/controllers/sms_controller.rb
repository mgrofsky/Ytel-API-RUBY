...
module YtelApi
  ...
  class SMSController < BaseController
    ...
    def create_sms_viewdetailsms(message_sid)
      # Prepare query url.
    ...
    # a sms message.
    # @return String response from the API call
    def create_sms_viewsms(message_sid)
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # by this date.
    # @return String response from the API call
    def create_sms_getinboundsms(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # @return String response from the API call
    def create_sms_listsms(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # phone.
    # @return String response from the API call
    def create_sms_sendsms(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
