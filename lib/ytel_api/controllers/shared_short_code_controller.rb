...
module YtelApi
  ...
  class SharedShortCodeController < BaseController
    ...
    def create_shortcode_viewshortcode(shortcode)
      # Prepare query url.
    ...
    # each keyword
    # @return String response from the API call
    def create_keyword_view(keywordid)
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # @return String response from the API call
    def create_shortcode_updateshortcode(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # @return String response from the API call
    def create_template_view(template_id)
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # shortcode
    # @return String response from the API call
    def create_shortcode_listshortcode(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # shortcode
    # @return String response from the API call
    def create_keyword_lists(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # @return String response from the API call
    def create_shortcode_sendsms(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # @return String response from the API call
    def create_shortcode_getinboundsms(options = {})
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
