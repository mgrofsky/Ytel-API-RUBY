...
```ruby
def create_deaf_mute_participant(options = Hash.new); end
```
...
```ruby
def create_verify_number(options = Hash.new); end
```
...
```ruby
def create_sub_account(options = Hash.new); end
```
...
```ruby
def create_suspend_sub_account(options = Hash.new); end
```
...
result = subAccount.create_suspend_sub_account(collect)
...
```ruby
def create_address(options = Hash.new); end
```
...
```ruby
def create_delete_address(options = Hash.new); end
```
...
result = address.create_delete_address(collect)
...
```ruby
def create_verify_address(options = Hash.new); end
```
...
result = address.create_verify_address(collect)
...
```ruby
def create_list_address(options = Hash.new); end
```
...
```ruby
def create_view_address(options = Hash.new); end
```
...
result = address.create_view_address(collect)
