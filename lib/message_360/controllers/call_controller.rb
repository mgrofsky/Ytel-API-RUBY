...
module Message360
  class CallController < BaseController
    ...
    # @param [HttpAction] method Optional parameter: Example: 
    # @param [String] status_call_back_url Optional parameter: Example: 
    # @param [HttpAction] status_call_back_method Optional parameter: Example: 
    # @param [String] fall_back_url Optional parameter: Example: 
    # @param [HttpAction] fall_back_method Optional parameter: Example: 
    # @param [String] heart_beat_url Optional parameter: Example: 
    # @param [HttpAction] heart_beat_method Optional parameter: Example: 
    ...
    # @param [HttpAction] record_call_back_method Optional parameter: Example: 
    ...
    # @param [Direction] direction Optional parameter: The leg of the call audio will be played to
